...
export const LoginPage = () => {
  ...
  // Demo bypass helper for hackathon presentation testing
  const handleDemoBypass = () => {
    // Write fake token to bypass auth guard
    const mockUser = {
      name: 'Sarah Connor',
      email: 's.connor@assetflow.com',
      role: 'Admin'
    };
    localStorage.setItem('token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.demo-token');
    localStorage.setItem('user', JSON.stringify(mockUser));
    
    // Hard refresh/state update simulated
    showToast('success', 'Demo Session Started! Logged in as Admin.');
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="pt-4 border-t border-secondary-100 flex flex-col items-center">
          ...
          >
            ...
            Demo Mode (Bypass API to land on Dashboard)
          </button>
        </div>
