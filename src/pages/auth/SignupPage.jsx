...
export const SignupPage = () => {
  ...
  // Presentation tool: simulate success
  const handleSimulateSuccess = () => {
    if (!values.name || !values.email || !values.password || !values.confirmPassword) {
      showToast('warning', 'Please fill out all fields before simulating.');
      return;
    }
    ...
    setRegisteredEmail(values.email);
    setIsRegistered(true);
    showToast('success', 'Demo registration simulated successfully!');
  };
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        {/* Hackathon Bypass UI for demonstration of verification screen */}
